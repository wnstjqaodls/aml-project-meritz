...
<%@ page import="com.gtone.rba.server.type03.RBA_50.RBA_50_05.RBA_50_05_08.RBA_50_05_08_01"  %>
...
<%
    ...
    DataObj output = RBA_50_05_08_01.getInstance().getSearchChart1(input);
...
//	 					loadChart(selectedRow.HGRK_BRNO);
    	    ...
    	    columns:
		     [
		         ...
		         },
		    	 {
		             ...
		             caption              : '${msgel.getMsg("RBA_50_04_01_02_001","통제분류Lv2")}',
		             alignment            : "center",
		             allowResizing        : true,
		             allowSearch          : true,
		             allowSorting         : true,
		         ...
		         },
		    	 {
		             ...
		             caption              : '${msgel.getMsg("RBA_50_04_01_01_002","통제분류Lv1")}',
		             alignment            : "center",
		             allowResizing        : true,
		             allowSearch          : true,
		             allowSorting         : true,
	...
	function doSearch() {
		...
		params.pageID 		   = "RBA_50_05_08_01";
		params.classID 		   = "RBA_50_05_08_01";
...
//	                  form2.classID.value   = "RBA_50_05_06_02";
	                 ...
	                 form2.CNTL_ELMN_C.value = rowdata.CNTL_ELMN_C;				// 위험요소
	                 form2.CNTL_ELMN_C_NM.value = rowdata.CNTL_ELMN_C_NM;				// 위험요소
	                 form2.BRNO_NM.value = rowdata.BRNO_NM;						// 대상부점
	                 
	                 console.log(form2.CNTL_CATG1_C.value);
	                 console.log(form2.CNTL_ELMN_C.value);
...
<form name="form1" method="post" >
	...
	<div style="display: flex; gap:20px;">
	    ...
	    <div class="tab-content-bottom" style="width:50%; padding-top:20px;">
			<div class="dash-board-cont-box">
                ...
                <div style="display:inline-block;width:calc(100%); height:500px; padding-top:4px;">
                    	<div id="chart1" style="width:100%;height:90%;text-align:center;"></div>
                    	<h6 style="font-size: small;">※ 기준 회차(조회 대상 평가 회차)의 평가 결과 중 통제효과성이 가장 낮은 5개 통제요소를 기준으로 표시</h6>
                </div>
			</div>
	    </div>
    </div>
