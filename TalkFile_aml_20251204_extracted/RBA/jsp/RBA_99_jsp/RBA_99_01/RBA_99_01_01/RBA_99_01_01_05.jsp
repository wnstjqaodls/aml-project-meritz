...
<%--
- File Name  : RBA_99_01_01_05.jsp
- Comment    : 내부통제 수료자 첨부파일 팝업
- Version    : 1.0
...
<script language="JavaScript">
	...
	function doSave_Action(){
		...
		form1.pageID.value = 'RBA_99_01_01_05';
		form1.classID.value = 'RBA_99_01_01_01';
// 		form1.afterClose.value = "N";

		var option = {
				url : '${ctx}/rba/99_01_01_02_doSaveFile.do',
				dataType : 'json',
...
// 						overlay.hide();
// 						
						if(window.opener && typeof window.opener.setGridFromExcel === "function"){
							window.opener.setGridFromExcel(data.output.gridData);
							
							console.log("data.gridData ::::" , data.output.gridData);
// 							console.log("window.opener ::::" , window.opener);
// 							console.log("fn ::::" , window.opener.setGridFromExcel);
						}
