    		...
    		elementAttr: { class: "grid-table-type" },
			 ...
			 hoverStateEnabled      : true
        	   ...
        	   ,export : {allowExportSelectedData: false,enabled: false,excelFilterEnabled: false}
	     	   ...
	     	   ,wordWrapEnabled : false
	     	   ,columns: [
	     	        {dataField: "HNDL_P_NM"		,caption: "결재자"		,alignment: "center",allowResizing: true,allowSearch: true,allowSorting: true,allowEditing: false, width : 120},
	      	        {dataField: "BRN_NM"		,caption: "소속부점"		,alignment: "center",allowResizing: true,allowSearch: true,allowSorting: true,allowEditing: false, width : 120},
	      	        {dataField: "ROLE_ID"		,caption: "결재자 ROLEID"	,alignment: "center",allowResizing: true,allowSearch: true,allowSorting: true,allowEditing: false, visible:false},
	      	        {dataField: "ROLE_NM"		,caption: "결재자 ROLEID"	,alignment: "center",allowResizing: true,allowSearch: true,allowSorting: true,allowEditing: false, width : 220},
	      	      	{dataField: "POSITION_NAME"	,caption: "직위"			,alignment: "center",allowResizing: true,allowSearch: true,allowSorting: true,allowEditing: false, width : 55},
	      	    	{dataField: "HNDL_DY_TM"	,caption: "결재일시"		,alignment: "center",allowResizing: true,allowSearch: true,allowSorting: true,allowEditing: false, width : 140},
	      	  		{dataField: "SN_CCD_YN"		,caption: "반려여부"		,alignment: "center",allowResizing: true,allowSearch: true,allowSorting: true,allowEditing: false,  visible:false},
	      			{dataField: "GYLJ_S_C"		,caption: "결재상태코드"	,alignment: "center"	,allowResizing: true,allowSearch: true,allowSorting: true,allowEditing: false, visible:false},
	      			{dataField: "GYLJ_S_C_NM"	,caption: "결재상태"	,alignment: "center"	,allowResizing: true,allowSearch: true,allowSorting: true,allowEditing: false, width : 85},
