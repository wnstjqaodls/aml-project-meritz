...
<script language="JavaScript">
    ...
    function setupFilter1(FLAG){
        ...
        gridObj.title = "${msgel.getMsg('RBA_50_05_01_020','대분류')}";
        gridArrs[0] = gridObj;
    ...
    function setupFilter2(FLAG){
        ...
        gridObj.title = "${msgel.getMsg('RBA_50_05_01_021','중분류')}";
        gridArrs[1] = gridObj;
    ...
    function setupFilter3(FLAG){
        ...
        gridObj.title = "${msgel.getMsg('RBA_50_05_01_022','소분류')}";
        gridArrs[1] = gridObj;
                ...
                onExporting: function (e) {
                    ...
                    DevExpress.excelExporter.exportDataGrid({
                        ...
                        workbook.xlsx.writeBuffer().then(function(buffer){
                            saveAs(new Blob([buffer], { type: "application/octet-stream" }), "통제기준관리_대분류.xlsx");
                        });
                    });
                    e.cancel = true;
                },
             ...
             hoverStateEnabled    : true,
                ...
                onExporting: function (e) {
                    ...
                    DevExpress.excelExporter.exportDataGrid({
                        ...
                        workbook.xlsx.writeBuffer().then(function(buffer){
                            saveAs(new Blob([buffer], { type: "application/octet-stream" }), "통제기준관리_중분류.xlsx");
                        });
                    });
                    e.cancel = true;
                },
             ...
             hoverStateEnabled    : true,
                ...
                onExporting: function (e) {
                    ...
                    DevExpress.excelExporter.exportDataGrid({
                        ...
                        workbook.xlsx.writeBuffer().then(function(buffer){
                            saveAs(new Blob([buffer], { type: "application/octet-stream" }), "통제기준관리_소분류.xlsx");
                        });
                    });
                    e.cancel = true;
                },
