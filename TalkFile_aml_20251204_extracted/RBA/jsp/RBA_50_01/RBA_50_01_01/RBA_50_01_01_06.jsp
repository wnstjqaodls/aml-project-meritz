...
<%@ page import="com.gtone.rba.server.type03.RBA_50.RBA_50_01.RBA_50_01_01.RBA_50_01_01_01"  %>
...
System.out.println("================================================= 파일 저장=======================================");
	...
	try {
		...
		if( "00000".equals(ERRCODE)  ) {
			...
			output = new DataObj();
		    output = RBA_50_01_01_01.getInstance().doSave(req); 
