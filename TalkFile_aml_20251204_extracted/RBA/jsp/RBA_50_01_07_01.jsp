    	...
    	GridObj1 = $("#GTDataGrid1_Area").dxDataGrid({
			 ...
			 hoverStateEnabled    : true,
			    ...
			    onExporting: function (e) {
				    ...
				    DevExpress.excelExporter.exportDataGrid({
				        ...
				        workbook.xlsx.writeBuffer().then(function(buffer){
				            saveAs(new Blob([buffer], { type: "application/octet-stream" }), "기준코드관리_그룹코드.xlsx");
				        });
				    });
				    e.cancel = true;
		        },			    
			    ...
			    columns: [
			        {
			            ...
			            dataField    : "NOTE_CTNT",
			            caption      : '${msgel.getMsg("RBA_50_01_07_01_100","코드설명")}',
			            alignment    : "left",
			            allowResizing: true,
			            allowSearch  : true,
			            allowSorting : true,
			    ...
			    onCellClick: function(e){
			    	if (e.component.isRowSelected(e.key) && ((e.data.IDU=="I" && e.columnIndex<=4) || (e.columnIndex>=2 && e.columnIndex<=4))){
			           ...
			           /*  if(e.data["DR_DT"]==undefined){
			        		e.component.columnOption('GRP_C', 'allowEditing', true);
			        	}else{
			        		e.component.columnOption('GRP_C', 'allowEditing', false);
			        	} */
			 ...
			 hoverStateEnabled    : true,
			    ...
			    onExporting: function (e) {
				    ...
				    DevExpress.excelExporter.exportDataGrid({
				        ...
				        workbook.xlsx.writeBuffer().then(function(buffer){
				            saveAs(new Blob([buffer], { type: "application/octet-stream" }), "기준코드관리_상세코드.xlsx");
				        });
				    });
				    e.cancel = true;
		        },			    
    ...
    function addRowGrid1(cmpnt){
		try {
            	...
            	GridObj2.option('dataSource', []);
          		cmpnt.addRow();
          		cmpnt.saveEditData();
          		cmpnt.columnOption('GRP_C', 'sortOrder', 'asc');
   ...
   function doSearch2_success(gridData, data){
    ...
    var doSave1 = function(gi) {
        ...
        for (var i=0;i<allRowsData.length; i++) {
            keyArr.push(allRowsData[i].GRP_C);
        }
        
        for (var i=0; i<rowsData.length; i++) {
            var obj = rowsData[i];
            if (obj.GRP_C=="") {
            	showAlert('${msgel.getMsg("AML_10_01_01_01_023","그룹코드를 입력하십시오.")}','WARN');
                return false;
            }
            if (obj.GRP_C_NM=="") {
            ...
            if (obj.GRP_B_C=="") {
            	showAlert('${msgel.getMsg("RBA_50_01_07_01_001","분류명을 입력하십시오.")}','WARN');

                return false;
            }
            var firstIndex = jQuery.inArray(obj.GRP_C, keyArr);
            if(obj.IDU=="U" || obj.IDU=="I") firstIndex++;
            if(jQuery.inArray(obj.GRP_C, keyArr, firstIndex)>-1){
    ...
    <div class="inquiry-table type1" id='condBox1'>
        <div class="table-row">
            <div class="table-cell">
            	<div class="title">
            		<div class="txt">${msgel.getMsg('codeGroup','코드그룹')}</div>
            	</div>
            	<div class="content">
					<select name="CCD" class="dropdown" >
        ...
        <div class="table-row">
            <div class="table-cell">
            	<div class="title">
            		<div class="txt"> ${msgel.getMsg('codeName','코드/명')}</div>
            	</div>
            	<div class="content">
