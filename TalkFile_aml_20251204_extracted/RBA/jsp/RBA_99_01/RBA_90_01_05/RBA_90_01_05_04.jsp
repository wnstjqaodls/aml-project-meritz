...
// 		   	showAlert('${msgel.getMsg("RBA_90_01_04_02_101","보고기준일을 입력하세요")}');
// 		    return  false;
// 		}
		...
		if(isNotEmpty(form1.elements["storedFileNms"]))
		{
			...
			if(fileCount > 1){
			    showAlert('${msgel.getMsg("RBA_90_01_04_02_100","파일을 2개이상 첨부할수 없습니다.")}', "WARN");
	            return false;
	        } else {
	 			if (form1.storedFileNms.value=="") {
	 				showAlert("${msgel.getMsg('RBA_90_01_05_04_001','파일을 첨부하지 않았습니다.')}", "WARN");
	 				return false;
	 			}
	 		}
		} else {
	...
	function doSave(){
		...
		showConfirm("${msgel.getMsg('RBA_90_01_06_01_109','저장하시겠습니까?')}", "${msgel.getMsg('RBA_90_01_05_01_108','저장')}", doSave_Action);
	}

	function doSave_Action(){
		form1.pageID.value = 'RBA_90_01_05_04';
		form1.afterClose.value = "N";

		var option = {
				url : '${ctx}/rba/RBA_90_01_05_04_doSaveFile.do',
				dataType : 'json',
				success : function(data){
					...
					{
						showAlert(data.serviceMessage, "ERR", doError_end);
					}
				}
		};
	...
	<div class="tab-content-bottom">
        <div class="statistics-table" >
			...
			<colgroup>
				...
				<tr>
                    <th class="title" width="10%">${msgel.getMsg('RBA_90_01_01_02_001','보고기준일')}</th>
		...
		<table border=0 width=100%>
			<tr class="tab-content-top">
					<td height="40" align="left" style="font-family: SpoqB;font-size:0.8rem;color:blue;">
