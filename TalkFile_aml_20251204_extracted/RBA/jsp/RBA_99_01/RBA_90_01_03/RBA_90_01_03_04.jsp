...
<%@ page import="com.gtone.rba.server.common.RBA_90.RBA_90_01.RBA_90_01_03.RBA_90_01_03_03"  %>
...
<%
	...
	try {
		...
		if( "00000".equals(ERRCODE)  ) {
			...
			output = new DataObj();
		    output = RBA_90_01_03_03.getInstance().doSaveFile(req); 
