...
<script>
    ...
    function doSearch()
    {
        ...
        GridObj1.refresh({
            actionParam     : {
                "pageID"            : "RBA_50_08_05_01"
               ,"classID"           : "RBA_50_08_05_01"
               ,"methodID"          : "doSearch"
               ,"stDate"            : getDxDateVal("stDate",true)
               ,"edDate"            : getDxDateVal("edDate",true)
               ,"BRNO_G_C"          : form.BRNO_G_C.value
    ...
    {         
        if(columnId == "ISPT_DT" ) {
            form2.pageID.value = 'RBA_50_08_05_02';
...
<form name="form" method="post">
	<input type="hidden" name="pageID" value="RBA_50_08_05_01">
    ...
    <div class="cond-box" id="condBox1">
        <div class="cond-row" style="visibility:hidden">
            <!-- 점검일자[ -->
            <div class="cond-item">
                ${condel.getInputDateDxPair('RBA_50_08_05_01_001','점검일자','stDate',stDate,'edDate',edDate)}
            </div>
            <!-- ]점검일자 -->
            <!-- 부점번호[ -->
            <div class="cond-item">
        ...
        <div class="cond-row" style="visibility:hidden">
            <!-- 지점구분코드[ -->
            <div class="cond-item">
                <span><i class="fa fa-chevron-circle-right" ></i>&nbsp;${msgel.getMsg('RBA_50_08_05_01_002','지점구분')}</span>
            ...
            <!-- 개선구분코드[ -->
            <div class="cond-item">
                <span><i class="fa fa-chevron-circle-right" ></i>&nbsp;${msgel.getMsg('RBA_50_08_05_01_003','개선구분')}</span>
