...
********************************************************************************************************************************************
* Project         : RBA
* File Name       : RBA_50_04_02_03.jsp
* Description     : 통제평가 배점 관리 파일 업로드 저장
...
<%@ page import="com.gtone.rba.server.type03.RBA_50.RBA_50_04.RBA_50_04_02.RBA_50_04_02_01"%>
...
<%
    ...
    try {
        ...
        if( "00000".equals(ERRCODE)  ) {
            output = RBA_50_04_02_01.getInstance().doSave(req);
