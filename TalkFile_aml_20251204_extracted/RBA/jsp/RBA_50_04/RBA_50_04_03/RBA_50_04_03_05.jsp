...
<div class="button-area" style="float:right">
    ...
    <% if ( ( "4".equals(ROLEID) &&  "20500".equals(BRNO) ) || "105".equals(ROLEID)) { // 3:AML담당자,4:준법감시팀 담당자.5:준법감시팀 책임자,6:RBA/AML책임자,7:ADMIN,105:RBA 담당자,104:보고책임자 %>
    ...
    <% } %>
	<% if ( ( "4".equals(ROLEID) &&  !"20500".equals(BRNO) ) || "104".equals(ROLEID) || "6".equals(ROLEID) ) { // 3:AML담당자,4:준법감시팀 담당자.5:준법감시팀 책임자,6:RBA/AML책임자,7:ADMIN,105:RBA 담당자,104:보고책임자 %>
