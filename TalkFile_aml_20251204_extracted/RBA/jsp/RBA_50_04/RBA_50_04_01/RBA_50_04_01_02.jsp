...
// 	var GridObj1 	= new GTActionRun();
    ...
    $(document).ready(function() {
        ...
        <%-- form1.USE_YN1.value = '<%= USE_YN1 %>';
        form1.CNTL_ELMN_CTNT.value = '<%= CNTL_ELMN_CTNT %>';
        form1.CNTL_RSK_CTNT.value = '<%= CNTL_RSK_CTNT %>';
        form1.EVAL_MTHD_CTNT.value = '<%= EVAL_MTHD_CTNT %>';
        form1.EVAL_TYPE_CD.value = '<%= EVAL_TYPE_CD %>';
        form1.PROOF_DOC_LIST.value = '<%= PROOF_DOC_LIST %>'; --%>
        /* form1.BRNO_NM.value = "test"; */
        <%-- form1.BRNO_NM.value = '<%= BRNO_NM %>'; --%>
    ...
    function doSave_Action(){
        ...
        form1.pageID.value 		= "RBA_50_04_01_02";
...
/*         form1.USE_YN            = $("#USE_YN1").val();
        form1.CNTL_ELMN_CTNT    = $("#CNTL_ELMN_CTNT1").val();
        form1.CNTL_RSK_CTNT     = $("#CNTL_RSK_CTNT1").val();
        form1.EVAL_MTHD_CTNT    = $("#EVAL_MTHD_CTNT1").val();
        form1.EVAL_TYPE_CD      = $("#EVAL_TYPE_CD1").val();
        form1.PROOF_DOC_LIST    = $("#PROOF_DOC_LIST1").val(); */

        //alert("USE_YN[" + $("#USE_YN1").val() + "]CNTL_ELMN_CTNT[" + $("#CNTL_ELMN_CTNT1").val() +"]CNTL_RSK_CTNT[" + $("#CNTL_RSK_CTNT1").val() +"]BAS_YYMM[" + "${BAS_YYMM}" );
...
/*     	if(!chkCommValidation("CHK_BAS_YYMM")) {showAlert('${msgel.getMsg("RBA_50_02_01_010","최근 평가기준월 데이터만 등록,수정,삭제 가능합니다.")}','WARN'); return;};
    ...
    function doDelete() {
		...
		if( GYLJ_S_C_NM != "미입력" && GYLJ_S_C_NM != "반려") {
		 ...
		 showConfirm('<fmt:message key="AML_10_01_01_01_007" initVal="삭제하시겠습니까?"/>', '삭제', doDelete_Action);
    }
    ...
    function doDelete_Action(){
        ...
        form1.pageID.value 		= "RBA_50_04_01_02";
        form1.classID.value 	= "RBA_50_04_01_02";
        form1.methodID.value 	= "doDeleteForCntl";
        form1.trCnt.value 		= $("#EvalInputTable tr").length-1;
        form1.target 			= "submitFrame";
        form1.action 			= "<c:url value='/'/>0001.do";
			   ...
			   <tbody>
			        <tr>
                     ...
                     <tr>
                    	...
                    	<td style="text-align: left;">${CNTL_ELMN_C_NM}</td>
		...
		<div class="table-box">
			<table class="basic-table" >
			   ...
			   <tr>
                	...
                	<%-- <td id="DEP_LIST" name="DEP_LIST" style="text-align: left;">${DEP_LIST}</td> --%>
                	<td style="text-align: left;" colspan="5">
