...
// 			             allowEditing         : true
			         },
	      	        {
						...
						calculateCellValue : function(rowData){
							if(rowData.ING_DT == null) return "";
							let v = String(rowData.ING_DT).trim();
							v = v.replace(/\D/g , "");
						...
						customizeText : function(e){
							if(!e.value) return "";
							return e.value.replace(/(\d{4})(\d{2})(\d{2})/, "$1-$2-$3");
						}
...
//               }
    ...
    function doSubmit_end2(fileData) {
		...
		params.actionName = "com.gtone.rba.server.common.RBA_99.RBA_99_01.RBA_99_01_01.RBA_99_01_01_01_Action";
