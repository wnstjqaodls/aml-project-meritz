...
* Description     : 고유위험조회_위험요소별 고유위험 조회
...
<%
    ...
    DataObj output = MDaoUtilSingle.getData("RBA_50_05_07_01_getChart" , input);
   	String chartDataJson = output.getText("CHART_DATA_JSON");
%>
...
// 		     },
		    ...
		    onCellPrepared : function(e){
	         ...
	         onRowPrepared : function(e){
		          if(e.rowType === 'data') {
					 if(e.data.RSK_VALT_ITEM_NM === "평가항목 전체"){
...
//	 					loadChart(selectedRow.HGRK_BRNO);
    	    ...
    	    columns:
		     [
		         ...
		         {caption      : '${msgel.getMsg("RBA_50_05_03_01_001","기준회차")}',
			            alignment    : "center", visible:true,
			            columns      : [
			            	{
					             dataField            : "CUR_JIPYO_V",
					             caption              : '${msgel.getMsg("RBA_50_05_03_01_202","지표발생량")}',
					             alignment            : "center",
					             allowResizing        : true,
					             allowSearch          : true,
					             allowSorting         : true,
			     ...
			     },
			     {
		             ...
		             caption              : '${msgel.getMsg("RBA_50_05_03_01_002","변동구분")}',
		             alignment            : "center",
		             lookup 			  : { 
											  dataSource  : [ 
												  		      {"KEY":"00","VALUE":"유지(-)"},
		    ...
		    ,summary :{totalItems: [{column: 'HGRK_BRNO_NM', summaryType: 'count', valueFormat: "fixedPoint"}],
	...
	function doSearch() {
		...
		var methodID = "doSearch8";
		
		params.pageID 		   = "RBA_50_05_07_01";
...
<form name="form1" method="post" >
    ...
    <div class="inquiry-table type1" id='condBox1'>
    	...
    	<div class="table-cell">
    		...
    		${condel.getLabel('RBA_50_05_03_01_002','변동구분')}
	       	<div class="content" >
