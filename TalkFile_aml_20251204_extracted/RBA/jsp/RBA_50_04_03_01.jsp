...
// 		if ( !checkVal() ) return;
    ...
    function doSearch09() {
    	...
    	var form2  = document.form2;   
        form2.pageID.value             = "RBA_50_04_03_09";
        form2.BAS_YYMM.value     = form1.BAS_YYMM.value;
        form2.target             = form2.pageID.value;
        var win                  = window_popup_open(form2.pageID.value, 1000, 800, '', 'yes');
        form2.action             = '<c:url value="/"/>0001.do';
...
<form name="form1" method="post" >
	...
	<div class="button-area">
		...
		${btnel.getButton(outputAuth, '{btnID:"btn_01", cdID:"RBA_Tongje_Search", defaultValue:"통제수행건수조회", mode:"R", function:"doSearch09", cssClass:"btn-36 filled"}')}
