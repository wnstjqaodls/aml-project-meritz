...
<%--
- File Name  : rbaFIURepoerExcelFileDownload.jsp.jsp
- Author     : NHM
...
<%
    ...
    try{
		...
		String fileName = "FIU_SampleReport";
    ...
    String ROLE_ID; ROLE_ID = StringHelper.evl(request.getParameter("ROLE_ID"), "");

    input.add("RPT_GJDT", RPT_GJDT);        //샘플값
