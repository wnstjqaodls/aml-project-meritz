...
<%--
- File Name  : RBA_50_07_03_01_ExcelFileDownload.jap
- Author     : 권얼
- Comment    : RBA 위험평가결과보고 Excel File Download
- Version    : 1.0
- history    : 1.0 2018-06-01
--%>
...
<%
    ...
    try {
        ...
        String down_file = BAS_YYMM + "_" + ServerConfig.getInstance().getProperty("RBA_KPMG_COMP_FILE");
