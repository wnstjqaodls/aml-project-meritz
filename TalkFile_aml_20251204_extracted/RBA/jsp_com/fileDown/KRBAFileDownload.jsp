...
<%@ page language="java" import="jspeed.base.util.StringHelper, com.gtone.aml.basic.common.data.DataObj" contentType="text/html;charset=utf-8" errorPage="/jspeed/common/error.jsp"  %><%
...
try {	
	...
	//String FILE_TYPE = StringHelper.evl(request.getParameter("FILE_TYPE"),"");
...
//		System.out.println("dddddddddddddddddd");
		...
		if( downFile.exists() ) 
		{
			...
			request.setAttribute("FILENAME", URLEncoder.encode(LOSC_FILE_NM , "UTF-8").replaceAll("\\+","%20") );	//수정, 2017-06-09 한글깨짐으로 인하여 소스 수정
			//request.setAttribute("FILENAME", new String(LOSC_FILE_NM.getBytes("UTF-8"),"8859_1") );				 기존소스
