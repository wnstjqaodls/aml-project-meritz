...
<%
	String BAS_YYYY = request.getParameter("basYyyy");
	String VALT_TRN = request.getParameter("valtTrn");
...
<script language="JavaScript">
	...
	function doSearch(){
		...
		param.BAS_YYYY     = jQuery("#BAS_YYYY").val();
		param.VALT_TRN     = jQuery("#VALT_TRN").val();
		
		goAjaxWidthReturn("com.gtone.rba.common.action.GetKRBAValtDepInfoListByNm", param, "onAfterDoSearch");
	}
...
<input type="hidden" id="BAS_YYYY" name="BAS_YYYY" value="${BAS_YYYY}">
<input type="hidden" id="VALT_TRN" name="VALT_TRN" value="${VALT_TRN}">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td height="30">
									<table border="0" cellpadding="0" cellspacing="0" class="btn_area">
										<tr>
											<td class="btn3"><span>부서 목록</span></td>
										</tr>
									</table>
								</td>
								<td align="right">
							...
							<tr>
								<td height="250" valign="top" class="base_box" colspan="2" id="GTDataGrid_Area">
									<table border="0" cellspacing="0" cellpadding="0" class="tbl_info" style="width: 100%;">
										<tr>
											<td class="tbl_Top" style="width: 30%;">조회선택</td>
											<td class="tbl_info_w">
												<select name='depInfoList' id='depInfoList'  multiple  ondblClick='javascript:setDepInfo(this);' style='width:100%;height:269px;color:#494949;text-align:center;border:solid;border-collapse:collapse;'>
												</select>
											</td>
										</tr>
									</table>
...
<table width="100%" border="0" align="right" cellpadding="2" cellspacing="0" class="btn_area">
	<tr>
		<td>
...
-->
	<div class="cond-box" id='condBox1'>
		<div class="cond-row">
			<div class="cond-item">
			<span><i class="fa fa-chevron-circle-right" ></i>&nbsp;부서명&nbsp;</span>
		...
		<div class="table-box" >
			<table width="100%" class="hover">
				<tr>
					...
					<td>
						<select name='depInfoList' id='depInfoList' multiple  ondblClick='javascript:setDepInfo(this);' style='width:100%;height:305px;color:#494949;text-align:left;border:solid;border-collapse:collapse;'>
						</select>
					</td>
				</tr>
			</table>
