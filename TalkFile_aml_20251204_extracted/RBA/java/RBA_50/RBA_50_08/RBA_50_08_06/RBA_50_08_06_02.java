...
public class RBA_50_08_06_02 extends GetResultObject{
    ...
    /** 인스턴스 */
    private static RBA_50_08_06_02 instance = null;
    
    /**
     * 인스턴스 반환.
     * <p>
     * @return  <code>RBA_50_08_06_02</code>
     */
	public static  RBA_50_08_06_02 getInstance() {
		synchronized(RBA_50_08_06_02.class) {  
			if (instance == null) {
				instance = new RBA_50_08_06_02();
			}
		}
		return instance;
	}  
     ...
     *              GRID_DATA(내부감사내역관리정보 DataSet),  PARAM_DATA ( grid param DataSet, STATUS = ‘00000’: 성공, ‘00001’:에러,  MESSAGE =alert 에러메시지, WINMSG= grid 상태 메시지)
    ...
    public DataObj doSave(DataObj input)
    {
        ...
        try {
        	// 순번 생성
        	snoOutput = MDaoUtilSingle.getData( "RBA_50_08_06_02_doGetSNO", input);
        	
        	input.put("SNO",snoOutput.getInt("SNO"));
        	
        	MDaoUtilSingle.setData("RBA_50_08_06_02_doSave", input);
    ...
    public DataObj doUpdate(DataObj input)
    {
        ...
        try {
        	//MDaoUtilSingle.setData("RBA_50_08_06_02_doUpdate", input);
    ...
    public DataObj doDelete(DataObj input) throws AMLException
    {
        ...
        try {
        	MDaoUtilSingle.setData("RBA_50_08_06_02_doDelete", input);  
     ...
     *              화면에서 보낸 입력 값,SessionHelper, SessionAML, menuID, pageID ==> input.getText("<키>")을 통해 값을 얻는다.
     * @return  <code>DataObj</code>
     *              GRID_DATA(내부감사 내역관리 DataSet),  PARAM_DATA ( grid param DataSet, STATUS = ‘00000’: 성공, ‘00001’:에러,  MESSAGE =alert 에러메시지, WINMSG= grid 상태 메시지)
     * @throws  <code>Exception</code>
     */    
    public DataObj getInAudtInfo(DataObj input)
    {
    	DataObj output = new DataObj();
    	DataSet gdRes = null;
    	
    	try {
    		output = MDaoUtilSingle.getData("RBA_50_08_06_02_GetInAudtInfo", input);
    		...
    		Log.logAML(Log.ERROR, this, "getInAudtInfo", e.getMessage());
			output = new DataObj();
			output.put("ERRCODE", "00001");
			output.put("WINMSG", MessageHelper.getInstance().getMessage("0005", input.getText("LANG_CD"), "처리중 오류가 발생하였습니다."));
    	}
