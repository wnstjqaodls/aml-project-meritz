 ...
 */
package com.gtone.rba.server.type03.RBA_50.RBA_50_01.RBA_50_01_07;
 ...
 */
public class RBA_50_01_07_01 extends GetResultObject {

	private static RBA_50_01_07_01 instance = null;
	/**
	* getInstance
	* @return RBA_30_01_04_01
	*/
	public static  RBA_50_01_07_01 getInstance() {
		synchronized(RBA_50_01_07_01.class) {
		    if (instance == null) {
			    instance = new RBA_50_01_07_01();
		    }
		}
		return instance;
	}
	...
	*/
	public DataObj doSearch(DataObj input) {
		...
		try {
			output = MDaoUtilSingle.getData("RBA_50_01_07_01_getSearch", input);
			// grid data
	...
	*/
	public DataObj doSearch2(DataObj input) {
		...
		try {
			output = MDaoUtilSingle.getData("RBA_50_01_07_01_getSearch2", input);
			// grid data
			if (output.getCount("GRP_C") > 0) {
				gdRes = Common.setGridData(output);
			}
    ...
    public DataObj doSave(DataObj input) throws AMLException {
		...
		try {
			...
			for (int i = 0; i < gdReq_size; i++) {
				...
				mDao.setData("RBA_50_01_07_01_mergeSRBA_GRP_C", inputMap);	
			}
    ...
    public DataObj doSave2(DataObj input) throws AMLException {
		...
		try {
			...
			for (int i = 0; i < gdReq_size; i++) {
				...
				mDao.setData("RBA_50_01_07_01_mergeSRBA_DTL_C", inputMap);	
			}
		...
		try {
			...
			mDao.begin();
				...
				for (int k = 0; k < gdReq_size; k++) {
					...
					output = MDaoUtilSingle.getData("RBA_50_01_07_01_getCount", inputMap_CNT);
				...
				if (cnt == 0 ){
					for (int i = 0; i < gdReq_size; i++) {
						...
						mDao.setData("RBA_50_01_07_01_Delete", inputMap);
						mDao.setData("RBA_50_01_07_01_Delete_1", inputMap);
					}
	...
	*/
    ...
    public DataObj doDelete2(DataObj input) throws AMLException {
		...
		try {
			...
			for (int i = 0; i < gdReq_size; i++) {
				HashMap inputMap = (HashMap) gdReq.get(i);
				mDao.setData("RBA_50_01_07_01_Delete2", inputMap);
			}
