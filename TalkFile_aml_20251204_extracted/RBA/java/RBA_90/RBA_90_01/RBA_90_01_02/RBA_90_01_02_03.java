 ...
 */
public class RBA_90_01_02_03 extends GetResultObject {

	private static RBA_90_01_02_03 instance = null;

	/**
	 * getInstance
	 * @return RBA_90_01_02_03
	 */
	public static  RBA_90_01_02_03 getInstance() {
		synchronized(RBA_90_01_02_03.class) {
		if ( instance == null ) {
			instance = new RBA_90_01_02_03();
		}
		}
		return instance;
	}
	...
	public DataObj getSearchEvaluationCode(DataObj input) {
		...
		try {
			...
			buf.append("<tr style='background-color: white;border-top: 1px solid #e9eaeb;'>  \n");
			buf.append("<td style='border-right:1px solid #CCCCCC' align='center' ><input type='checkbox' id='EVAL_DATE_SEL' name='EVAL_DATE_SEL' /><label for='EVAL_DATE_SEL'></label></td>  \n");
			buf.append("<td style='border-right:1px solid #CCCCCC;padding:5px' align='center'><input type='text' class='input_text' onkeyup='onlyNumber1(this);' onkeypress='onlyNumber1(this);'  id='CAL_PNT' name='CAL_PNT' /></td>  \n");
			buf.append("<td style='border-right:1px solid #CCCCCC;padding:5px' align='center'>  \n");
			...
			if ( EvalCmprCalC != null ) {
				buf.append("<select id='JIPYO_CMPR_CAL_C' name='JIPYO_CMPR_CAL_C' style='width: 100%' class='dropdown'>  \n");
			...
			buf.append("</td>  \n");
			buf.append("<td style='border-right:1px solid #CCCCCC' align='center'>  \n");
			if ( "C".equals(IN_V_TP_C) ) { //CODE
				...
				if ( EvalCmprV == null ) {
					buf.append("<select id='CMPR_V' name='CMPR_V' style='width: 100%' class='cond-select' >  \n");
				...
				buf.append("<input type='text' class='input_text' onkeyup='onlyNumber1(this);' onkeypress='onlyNumber1(this);' id='CMPR_V' name='CMPR_V' style='width: 100%' />  \n");

			} else { //TEXT
				buf.append("<input type='text' class='input_text' id='CMPR_V' name='CMPR_V' style='width: 100%' />  \n");
			}
