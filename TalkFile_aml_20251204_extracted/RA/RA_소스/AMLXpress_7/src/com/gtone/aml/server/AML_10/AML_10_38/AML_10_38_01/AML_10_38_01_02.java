 ...
 ******************************************************************************************************************************************
	/** 인스턴스 */
public class AML_10_38_01_02 extends GetResultObject {
	private static AML_10_38_01_02 instance = null;
	 ...
	 */
	public static AML_10_38_01_02 getInstance() {
		return instance == null ? (instance = new AML_10_38_01_02()) : instance;
	}
    ...
    public DataObj firstAppRequest(DataObj input ) throws AMLException {
        ...
        try {
			...
			if(input.size() > 0) {
	        	...
	        	db.setData("AML_10_38_01_02_update_RA_ITEM_STD_APPR", output3);
	            db.setData("AML_10_38_01_02_update_RA_ITEM_STD_REQ", output3);
        ...
        try {
            ...
            if(input.size() > 0 ) {
	        	...
	        	if("E".equals(gubunSN_CCD)) {
		        	db.setData("AML_10_38_01_02_update_RA_ITEM_STD_APPR2", output2);
		        	db.setData("AML_10_38_01_02_update_RA_ITEM_STD_REQ2", output2);
	        	}else {
		        	db.setData("AML_10_38_01_02_update_RA_ITEM_STD_APPR3", output2);
		        	db.setData("AML_10_38_01_02_update_RA_ITEM_STD_REQ4", output2);
	        	}
				db.commit();

				if("E".equals(gubunSN_CCD)) {
					db2.setData("AML_10_38_01_02_update_RA_ITEM_STD", output2);
				}
				db2.commit();
            }
	...
	public DataObj doApprHist(DataObj input) {
		...
		try {
				output = MDaoUtilSingle.getData("AML_10_38_01_02_RA_ITEM_STD_doApprHist", input);
	...
	public DataObj doApprHist2(DataObj input) {
		...
		try {
			...
			output = MDaoUtilSingle.getData("AML_10_38_01_02_RA_ITEM_STD_doApprHist2", input);

			// grid data
			if ( output.getCount("STD_SEQ") > 0 ) {
				gdRes = Common.setGridData(output);
			}
			/*
			else {
	...
	public DataObj doApprHist3(DataObj input) {
		...
		try {
			output = MDaoUtilSingle.getData("AML_10_38_01_02_RA_ITEM_STD_doApprHist3", input);
