...
<script language="JavaScript">
	...
	function doSave(){  
	  ...
	  var minLen = inputText.replace(/\s/g , "").length;
	  	   ...
	  	   //if(ROLEID == '4') {
	  		 	if(minLen < 10){
	  				showAlert( "${msgel.getMsg('AML_10_25_02_01_016', '반려의견은 최소 10자(공백 제거) 이상 입력해야 합니다.')}", "WARN");
	 	     		return;
	 	    	}
	  	   //}
...
<form name="form1" method="post">
	...
	<div class="popup-cont-box">
	    <div class="cond-box" id="condBox1" style="margin-top:0px;margin-bottom:0px">
	        ...
	        <div class="cond-row">
	        	<div style="font-size:15px; margin-top: 8px;">결재의견</div>  	               
