...
<script>
    ...
    function doSearch_success(gridData, data)
    {
        ...
        if(gridData.length>0){
            ...
            form1.RA_CORJOB_YN1.value     = obj.RA_CORJOB_YN1;
            form1.RA_CORJOB_YN2.value     = obj.RA_CORJOB_YN2;
            form1.RA_CORJOB_YN3.value     = obj.RA_CORJOB_YN3;
            form1.RA_CORJOB_YN4.value     = obj.RA_CORJOB_YN4;
            form1.RA_CORJOB_YN5.value     = obj.RA_CORJOB_YN5;
            form1.RA_CORJOB_YN6.value     = obj.RA_CORJOB_YN6;
            form1.RA_CORJOB_YN7.value     = obj.RA_CORJOB_YN7;
            form1.RA_CORJOB_YN8.value     = obj.RA_CORJOB_YN8;
            form1.RA_CORJOB_STA_YN1.value = obj.RA_CORJOB_STA_YN1;
            form1.RA_CORJOB_STA_YN2.value = obj.RA_CORJOB_STA_YN2;
            form1.RA_CORJOB_STA_YN3.value = obj.RA_CORJOB_STA_YN3;
            form1.RA_CORJOB_STA_YN4.value = obj.RA_CORJOB_STA_YN4;
            form1.RA_CORJOB_STA_YN5.value = obj.RA_CORJOB_STA_YN5;
        }
    }
    ...
    function doSave() {
        ...
        params.RA_CORJOB_YN1      = getCheckedRadio("RA_CORJOB_YN1");
        params.RA_CORJOB_YN2      = getCheckedRadio("RA_CORJOB_YN2");
        params.RA_CORJOB_YN3      = getCheckedRadio("RA_CORJOB_YN3");
        params.RA_CORJOB_YN4      = getCheckedRadio("RA_CORJOB_YN4");
        params.RA_CORJOB_YN5      = getCheckedRadio("RA_CORJOB_YN5");
        params.RA_CORJOB_YN6      = getCheckedRadio("RA_CORJOB_YN6");
        params.RA_CORJOB_YN7      = getCheckedRadio("RA_CORJOB_YN7");
        params.RA_CORJOB_YN8      = getCheckedRadio("RA_CORJOB_YN8");

        params.RA_CORJOB_STA_YN1  = getCheckedRadio("RA_CORJOB_STA_YN1");
        params.RA_CORJOB_STA_YN2  = getCheckedRadio("RA_CORJOB_STA_YN2");
        params.RA_CORJOB_STA_YN3  = getCheckedRadio("RA_CORJOB_STA_YN3");
        params.RA_CORJOB_STA_YN4  = getCheckedRadio("RA_CORJOB_STA_YN4");
        params.RA_CORJOB_STA_YN5  = getCheckedRadio("RA_CORJOB_STA_YN5");
	...
	<table class="basic-table" style="table-layout:fixed;">
		<tbody>
			...
			<tr>
	            ...
	            <td style="text-align:center;">
	            	${radioel.getRadioBtns('{radioBtnID:"RA_CORJOB_YN1",cdID:"N003",initValue:""}')}
	            </td>
            </tr>
            <tr>
	            <td style="text-align: center;">
	            ...
	            <td style="text-align:center;">
	            	${radioel.getRadioBtns('{radioBtnID:"RA_CORJOB_YN2",cdID:"N003",initValue:""}')}
	            </td>
            </tr>
            <tr>
	            <td style="text-align: center;">
	            ...
	            <td style="text-align:center;">
	            	${radioel.getRadioBtns('{radioBtnID:"RA_CORJOB_YN3",cdID:"N003",initValue:""}')}
	            </td>
            </tr>
            <tr>
	            <td style="text-align: center;">
	            ...
	            <td style="text-align:center;">
	            	${radioel.getRadioBtns('{radioBtnID:"RA_CORJOB_YN4",cdID:"N003",initValue:""}')}
	            </td>
            </tr>
            <tr>
	            <td style="text-align: center;">
	            ...
	            <td style="text-align:center;">
	            	${radioel.getRadioBtns('{radioBtnID:"RA_CORJOB_YN5",cdID:"N003",initValue:""}')}
	            </td>
            </tr>
            <tr>
	            <td style="text-align: center;">
	            ...
	            <td style="text-align:center;">
	            	${radioel.getRadioBtns('{radioBtnID:"RA_CORJOB_YN6",cdID:"N003",initValue:""}')}
	            </td>
            </tr>
            <tr>
	            <td style="text-align: center;">
	            ...
	            <td style="text-align:center;">
	            	${radioel.getRadioBtns('{radioBtnID:"RA_CORJOB_YN7",cdID:"N003",initValue:""}')}
	            </td>
            </tr>
            <tr>
	            <td style="text-align: center;">
	            ...
	            <td style="text-align:center;">
	            	${radioel.getRadioBtns('{radioBtnID:"RA_CORJOB_STA_YN1",cdID:"N003",initValue:""}')}
	            </td>
            </tr>
            <tr>
	            <td style="text-align: center;">
	            ...
	            <td style="text-align:center;">
	            	${radioel.getRadioBtns('{radioBtnID:"RA_CORJOB_STA_YN2",cdID:"N003",initValue:""}')}
	            </td>
            </tr>
            <tr>
	            <td style="text-align: center;">
	            ...
	            <td style="text-align:center;">
	            	${radioel.getRadioBtns('{radioBtnID:"RA_CORJOB_STA_YN3",cdID:"N003",initValue:""}')}
	            </td>
            </tr>
            <tr>
	            <td style="text-align: center;">
	            ...
	            <td style="text-align:center;">
	            	${radioel.getRadioBtns('{radioBtnID:"RA_CORJOB_STA_YN4",cdID:"N003",initValue:""}')}
	            </td>
            </tr>
            <tr>
	            <td style="text-align: center;">
	            ...
	            <td style="text-align:center;">
	            	${radioel.getRadioBtns('{radioBtnID:"RA_CORJOB_STA_YN5",cdID:"N003",initValue:""}')}
	            </td>
            </tr>
            <tr>
	            <td style="text-align: center;">
	            ...
	            <td style="text-align:center;">
	            	${radioel.getRadioBtns('{radioBtnID:"RA_CORJOB_YN8",cdID:"N003",initValue:""}')}
	            </td>
            </tr>
		</tbody>
	</table>
