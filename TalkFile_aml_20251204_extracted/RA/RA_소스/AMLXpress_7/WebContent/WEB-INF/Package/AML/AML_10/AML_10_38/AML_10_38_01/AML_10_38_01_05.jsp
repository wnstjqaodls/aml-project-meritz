...
<script>
    ...
    function doSearch2(obj) {
		...
		var STD_SEQ   = form1.STD_SEQ.value;
		
        var params     = new Object();
        params.pageID  = pageID;
		params.STD_SEQ = STD_SEQ;
    		...
    		elementAttr: { class: "grid-table-type" },
			 ...
			 hoverStateEnabled      : true
        	   ...
        	   ,export : {allowExportSelectedData: false,enabled: false,excelFilterEnabled: false}
	     	   ...
	     	   ,wordWrapEnabled : false
	     	  ,columns: [
	     		  	{dataField: "STD_SEQ"		    	,caption: "시퀀스"				,alignment: "center",allowResizing: true,allowSearch: true,allowSorting: true,allowEditing: false, visible:false},
	      	        ...
	      	        {dataField: "CS_TYP_NM"				,caption: "개인법인구분"		,alignment: "center",allowResizing: true,allowSearch: true,allowSorting: true,allowEditing: false, visible:true},
	      	        ...
	      	        {dataField: "NEW_OLD_GBN_NM"		,caption: "모델구분"		,alignment: "center",allowResizing: true,allowSearch: true,allowSorting: true,allowEditing: false, visible:true},
	      	    	...
	      	    	{dataField: "RA_GRD_NM"				,caption: "위험등급"	,alignment: "center",allowResizing: true,allowSearch: true,allowSorting: true,allowEditing: false, visible:true},
	      	    	{dataField: "RA_GRD_SCR"			,caption: "변경전 구간값"	,alignment: "center",allowResizing: true,allowSearch: true,allowSorting: true,allowEditing: false, visible:true},
	      	    	{dataField: "MODI_RA_GRD_SCR"		,caption: "변경후 구간값"			,alignment: "center",allowResizing: true,allowSearch: true,allowSorting: true,allowEditing: false, visible:true}
...
<form name=form1 method="post">
	...
	<input type="hidden" name="STD_SEQ" >
