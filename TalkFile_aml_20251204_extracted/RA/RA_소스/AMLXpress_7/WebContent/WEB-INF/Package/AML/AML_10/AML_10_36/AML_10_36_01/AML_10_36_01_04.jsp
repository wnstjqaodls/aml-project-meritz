...
<%
	...
	String searchgubun   = Util.nvl(request.getParameter("searchgubun"));
...
<script>
        	   ...
        	   ,export : {allowExportSelectedData: false,enabled: false,excelFilterEnabled: false}
	     	   ...
	     	   ,columns: [
	     	        {dataField: "HNDL_P_NM"		,caption: "결재자"		,alignment: "center",allowResizing: true,allowSearch: true,allowSorting: true,allowEditing: false},
	      			...
	      			{dataField: "RSN_CNTNT"		,caption: "결재/반려의견"	,alignment: "center"	,allowResizing: true,allowSearch: true,allowSorting: true,allowEditing: false}
	      	    ]
	      	    // events
    ...
    function doAppr(){
    	...
    	if ($("#RSN_CNTNT").val() == "") {
            showAlert("${msgel.getMsg('AML_10_01_01_01_041','반려의견을 입력하세요.')}",'WARN');
            return;
        }

         var mesg = '${msgel.getMsg("AML_10_17_01_01_016","반려하시겠습니까?")}';
         var mesg2 ='${msgel.getMsg("AML_10_17_01_01_013","반려")}';
        ...
        showConfirm(mesg,mesg2,function(){
            ...
            sendService(classID, methodID, params, doSave_success, doSave_success);
        });
    }
    ...
    function doSave_success()
    {
    	...
    	if(searchgubun == "Y") {
    		opener.doSearch2();
    	}else if(searchgubun == "N") {
    		opener.doSearch();
            opener.opener.doSearch2();
    	}
    }
...
<div class="tab-content">
	...
	<div class="row" style="padding-top: 8px">
		<h4 class="tab-content-title">반려 실행</h4>
	</div>

    	<table class="basic-table">
        	<tr>
            	<th class="title" style="text-align: center">반려자</th>
            	...
            	<td style="text-align: center"> <input type=text  name="BDPTCDNAME" id="BDPTCDNAME" style="text-align: center" readonly></td>
        	</tr>
        	<tr>
        		<th class="title" style="text-align: center">직위</th>
            	<td style="text-align: center"> <input type=text  name="POSITION_NAME" id="POSITION_NAME" style="text-align: center" readonly></td>
            	<th class="title" style="text-align: center">반려일자</th>
            	<td style="text-align: center"> <input type=text  name="stDate" id="stDate" style="text-align: center" readonly></td>
        	</tr>
        	<tr>
        		<th class="title" style="text-align: center">반려의견</th>
...
<div class="button-area" style="float:right">
    ${btnel.getButton(outputAuth, '{btnID:"sbtn_01", cdID:"denyBtn", defaultValue:"반려", mode:"C", function:"doAppr", cssClass:"btn-36"}')}
