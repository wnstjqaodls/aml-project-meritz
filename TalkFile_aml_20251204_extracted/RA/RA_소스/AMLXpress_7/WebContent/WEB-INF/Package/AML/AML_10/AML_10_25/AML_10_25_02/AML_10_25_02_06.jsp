...
<%
    ...
    String gyljlinegc = Util.nvl( request.getParameter("gyljlinegc") );
	request.setAttribute("APP_NO", appNo);
	request.setAttribute("gyljlinegc", gyljlinegc);
%>
...
<script language="JavaScript">
	         ...
	         "elementAttr" : { class: "grid-table-type" },
   	         ...
   	         "columns":[
                    {"dataField":"LOGIN_ID","caption": "${msgel.getMsg('AML_10_25_01_01_009', '사번')}","alignment": "center","allowResizing": true,"allowSearch": true,"allowSorting": false,"allowEditing": false, "width": "10%" }
   	              ...
   	              , {"dataField":"ROLE_NM","caption": "${msgel.getMsg('AML_10_25_01_01_012', '권한구분')}","alignment": "center","allowResizing": true,"allowSearch": true,"allowSorting": false,"allowEditing": false, "width": "15%"}
   	              ...
   	              , {"dataField":"SN_CCD_NM","caption": "${msgel.getMsg('AML_10_25_01_01_014', '결재상태')}","alignment": "center","allowResizing": true,"allowSearch": true,"allowSorting": false,"allowEditing": false, "width": "15%" }
	...
	function doSearch(){
	    ...
	    params.gyljlinegc = "${gyljlinegc}";
	    
	    sendService("AML_10_25_02_01", "getApprHstSearch", params, doSearch_end, doSearch_end); 
	}
